...
ServerApplicationAgent::ServerApplicationAgent(Node *_hostNode) : ApplicationAgent(_hostNode) {
  //cout << "ServerApplicationAgent constructor" << endl;
}
ServerApplicationAgent::~ServerApplicationAgent() {
  //cout << "ServerApplicationAgent destructor" << endl;
}
