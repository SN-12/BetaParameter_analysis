...
#ifndef AGENTS_SLR_RING_ROUTING_AGENT_H_
#define AGENTS_SLR_RING__ROUTING_AGENT_H_
...
class SLRRingRoutingAgent: public RoutingAgent {
...
protected:
  ...
  map<int, Contro12_t> ring;
  bool alreadySent1and2;
  distance_t range1, range2;

public:
  SLRRingRoutingAgent(Node *_hostNode);
  virtual ~SLRRingRoutingAgent();
...
#endif /* AGENTS_SLR_RING_ROUTING_AGENT_H_ */
